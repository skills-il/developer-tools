...
- **[references/hebrew-rtl.md](references/hebrew-rtl.md)**, Hebrew and RTL compositions: `dir="rtl"` scoping, Google Fonts auto-fetch for Heebo/Rubik/Assistant, GSAP x-axis mirroring, Hebrew captions via `hyperframes transcribe --language he`, Hebrew voiceover via external TTS, bidirectional text with `<bdi>`. Read for any composition with Hebrew text.
