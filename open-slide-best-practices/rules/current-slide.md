...
- The [./apply-comments.md](./apply-comments.md) workflow already finds the right file via `@slide-comment` markers; it doesn't need this skill.
...
3. Consult [./slide-authoring.md](./slide-authoring.md) for type-scale and layout rules before editing.
