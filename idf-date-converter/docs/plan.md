# IDF Date Converter Skill — Implementation Plan

> **For Claude:** REQUIRED SUB-SKILL: Use superpowers:executing-plans to implement this plan task-by-task.

**Goal:** Build a skill for converting between Hebrew (Jewish) calendar and Gregorian dates, including handling Israeli holidays, Shabbat times, and date formatting for Israeli documents.

**Architecture:** Document/Asset Creation skill (Category 1). Embeds Hebrew calendar knowledge and conversion logic.

**Tech Stack:** SKILL.md, Python date conversion script using hebcal library.
...
- Lunisolar calendar: 12 months (13 in leap years)
- Months: Tishrei, Cheshvan, Kislev, Tevet, Shevat, Adar (Adar I/II in leap), Nisan, Iyar, Sivan, Tammuz, Av, Elul
- Year starts: 1 Tishrei (Rosh Hashana)
- Current year (2026 Gregorian): ~5786 Hebrew
- Leap year cycle: 7 leap years in every 19-year cycle (years 3, 6, 8, 11, 14, 17, 19)

### Israeli Date Formatting
- Documents often show dual dates: "15 February 2026 / 17 Shevat 5786"
- Hebrew date written right-to-left with Hebrew numerals (gematria)
- Government forms may require both dates
...
### Use Cases
1. **Convert date** — Gregorian to Hebrew or vice versa
2. **Israeli holiday lookup** — When does a holiday fall this year
3. **Dual date formatting** — Format dates for Israeli documents
4. **Business day calculation** — Account for Shabbat and holidays
5. **Shabbat times** — Candle lighting and havdalah times by city
...
| Request | Action |
|---------|--------|
| Convert specific date | Gregorian <-> Hebrew conversion |
...
Result: "24 February 2026 = 26 Adar I 5786 (כ"ו באדר א' תשפ"ו)"
