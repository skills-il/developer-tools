...
6. **`direction: "rtl"` על אלמנט אב לא מתקן סדר ב-flex.** שורות של אייקון + טקסט עברי (צ'קמרקים, בולטים) עדיין יציגו את האייקון בצד שמאל. תשתמשו ב-`flexDirection: "row-reverse"` על כל שורת flex כדי שהאייקון יופיע בצד ימין (תחילת הקריאה בעברית). לעולם אל תשימו `direction: "ltr"` על span של טקסט עברי בתוך flex שהוא RTL.
