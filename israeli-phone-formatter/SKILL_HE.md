...
כשאתם צריכים אימות בקוד, ספקו פונקציה דרך דפוסי regex מתוך `references/prefix-allocation.md`. כללו:
...
פתרון: למספרים אלה אין מקבילה בינלאומית. אם אתם צריכים נגישות בינלאומית, הציעו לספק מספר קווי או נייד רגיל במקום.