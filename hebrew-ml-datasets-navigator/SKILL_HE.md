...
- `oscar-corpus/OSCAR-2301`, קורפוס רב-לשוני שמקורו ב-CommonCrawl, חתך עברי זמין. שימו לב ש-`OSCAR-2301` תחת gating ב-HuggingFace, ונכון לאמצע 2026 הגישה **מושהית זמנית** (המתחזקים עצרו מתן גישות חדשות עד להבהרה משפטית). השתמשו ב-`uonlp/CulturaX` (גם תחת gating אך ניתן לקבל גישה) או ב-`HuggingFaceFW/fineweb-2` לאותו צורך של web-scale עברי עד שהגישה ל-OSCAR תיפתח מחדש.
...
- `oscar-corpus/OSCAR-2301` תחת gating ב-HuggingFace, ונכון לאמצע 2026 הגישה **מושהית זמנית** (אין מתן גישות חדשות). אל תבנו pipeline שתלוי בו כרגע; השתמשו ב-CulturaX או FineWeb-2. `uonlp/CulturaX` גם תחת gating (הסכם עם פרטי קשר) אך הבקשות מטופלות.
