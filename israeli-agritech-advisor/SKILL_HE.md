...
> **הערה:** כתובת ה-API של GrowSphere הנה היא להמחשה בלבד. GrowSphere היא אפליקציית צרכנים ונטפים לא מפרסמת API ציבורי מתועד. פנו לנטפים ישירות לקבלת גישת API/שותפות.
